...
function map() {
	...
	var popup = new mapboxgl.Popup()
	.setHTML('<h2>Rotterdam The Hague Airport</h2><h3>Dit is momenteel de beste plek om te landen.</h3>');

	// Adding a marker based on lon lat coordinates
	var marker = new mapboxgl.Marker()
	.setLngLat([4.434286, 51.948313])
	.setPopup(popup)
	.addTo(map);
	...
	//locaties waar het weer getoond moet worden
	var cities = [
	  {
	    name: 'Schiphol Airport',
	    coordinates: [4.768274, 52.310539]
	  },
	  {
	    name: 'Rotterdam The Hague Airport',
	    coordinates: [4.434286, 51.948313]
	  },
